...
class Loaders:
    ...
    def __init__(self, resources, base_size):
        ...
        #ENEMIES
        self.skeleton1 = Enemy("Weak Skeleton", 10, 10, base_size, 100, 15, 10, 10, 13, 2, 5, DirectionTypes.BOT_MID, 5, 10, 15, True, pygame.image.load('images/enemies/skeleton1.png').convert_alpha(), MovementType.RANDOM)
        ...
        self.skeleton2 = Enemy("Strong Skeleton", 10, 11, base_size, 300, 10, 12, 1, 3, 4, 4, DirectionTypes.TOP_MID, 10, 30, 20, True, pygame.image.load('images/enemies/skeleton1.png').convert_alpha(), MovementType.RANDOM)
